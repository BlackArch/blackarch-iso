...
fluxbox_entry()
{
    echo "          [exec] (${tool}) {urxvt -e bash '${tool} ${opts} bash'}" >> fluxbox-menu
...
openbox_entry()
{
    ...
    echo "          <command>urxvt -e bash '${tool} ${opts} bash'</command>" >> openbox-menu
...
awesome_entry()
{
    echo "  { \"${tool}\", \"urxvt -e bash '${tool} ${opts} bash'\" }," >> awesome-menu
...
make_menus()
{
    ...
    exclude="${exclude}|.css|.sh|.md|.app|.class|.pl|.rb|.ps|.ps1"
