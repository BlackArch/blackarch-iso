...
_tr_add2 after_install_etltip  "Mostrar o que fazer para atualizar o seu sistema blackarch para o nível mais recente"
...
_tr_add2 general_info_text     "Encontre o seu caminho para o sítio do blackarch$_exclamation"
